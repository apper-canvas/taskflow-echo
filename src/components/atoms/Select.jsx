...
const Select = forwardRef(({ 
  ...
  return (
    <select
      ref={ref}
className={cn(
        "w-full px-4 py-2.5 bg-white dark:bg-gray-800 border-2 rounded-lg text-gray-900 dark:text-gray-100",
